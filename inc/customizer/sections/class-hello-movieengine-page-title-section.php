...
class Hello_Movie_Engine_Page_Title_Section {
	...
	public static function register( $wp_customize ) {
		...
		$wp_customize->add_control( new Hello_Movie_Engine_Customize_Heading_Control( $wp_customize, 'hello_movieengine_heading_page_title_visibility', array(
		...
		$wp_customize->add_control( new Hello_Movie_Engine_Customize_Multiselect_Control( $wp_customize, 'hello_movieengine_page_title_locations', array(
		...
		$wp_customize->add_control( new Hello_Movie_Engine_Customize_Heading_Control( $wp_customize, 'hello_movieengine_heading_page_title_style', array(
		...
		$wp_customize->add_control( new Hello_Movie_Engine_Customize_Spacing_Control( $wp_customize, 'hello_movieengine_page_title_padding', array(
		...
		$wp_customize->add_control( new Hello_Movie_Engine_Customize_Heading_Control( $wp_customize, 'hello_movieengine_heading_page_title_background', array(
		...
		$wp_customize->add_control( new Hello_Movie_Engine_Customize_Alpha_Color_Control( $wp_customize, 'hello_movieengine_page_title_bg', array(
		...
		$wp_customize->add_control( new Hello_Movie_Engine_Customize_Alpha_Color_Control( $wp_customize, 'hello_movieengine_page_title_overlay', array(
