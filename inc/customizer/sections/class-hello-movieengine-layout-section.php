...
class Hello_Movie_Engine_Layout_Section {
	...
	public static function register( $wp_customize ) {
		...
		$wp_customize->add_control( new Hello_Movie_Engine_Customize_Heading_Control( $wp_customize, 'hello_movieengine_heading_container', array(
		...
		$wp_customize->add_control( new Hello_Movie_Engine_Customize_Heading_Control( $wp_customize, 'hello_movieengine_heading_content_layout', array(
		...
		$wp_customize->add_control( new Hello_Movie_Engine_Customize_Spacing_Control( $wp_customize, 'hello_movieengine_content_padding', array(
		...
		$wp_customize->add_control( new Hello_Movie_Engine_Customize_Heading_Control( $wp_customize, 'hello_movieengine_heading_sidebar', array(
		...
		$wp_customize->add_control( new Hello_Movie_Engine_Customize_Toggle_Control( $wp_customize, 'hello_movieengine_sidebar_enable', array(
		...
		$wp_customize->add_control( new Hello_Movie_Engine_Customize_Heading_Control( $wp_customize, 'hello_movieengine_heading_blog_grid', array(
