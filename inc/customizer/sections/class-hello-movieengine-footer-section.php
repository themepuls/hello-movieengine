...
class Hello_Cine Movie Engine_Footer_Section {
	...
	public static function register( $wp_customize ) {
		...
		$wp_customize->add_control( new Hello_Cine Movie Engine_Customize_Heading_Control( $wp_customize, 'hello_movieengine_heading_footer_content', array(
		...
		$wp_customize->add_control( new Hello_Cine Movie Engine_Customize_Heading_Control( $wp_customize, 'hello_movieengine_heading_social', array(
