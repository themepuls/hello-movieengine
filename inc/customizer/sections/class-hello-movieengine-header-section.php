...
class Hello_Cine Movie Engine_Header_Section {
	...
	public static function register( $wp_customize ) {
		...
		$wp_customize->add_control( new Hello_Cine Movie Engine_Customize_Heading_Control( $wp_customize, 'hello_movieengine_heading_header_layout', array(
		...
		$wp_customize->add_control( new Hello_Cine Movie Engine_Customize_Toggle_Control( $wp_customize, 'hello_movieengine_header_search', array(
		...
		$wp_customize->add_control( new Hello_Cine Movie Engine_Customize_Toggle_Control( $wp_customize, 'hello_movieengine_header_user_menu', array(
		...
		$wp_customize->add_control( new Hello_Cine Movie Engine_Customize_Toggle_Control( $wp_customize, 'hello_movieengine_header_border', array(
		...
		$wp_customize->add_control( new Hello_Cine Movie Engine_Customize_Heading_Control( $wp_customize, 'hello_movieengine_heading_header_spacing', array(
		...
		$wp_customize->add_control( new Hello_Cine Movie Engine_Customize_Spacing_Control( $wp_customize, 'hello_movieengine_header_padding', array(
		...
		$wp_customize->add_control( new Hello_Cine Movie Engine_Customize_Heading_Control( $wp_customize, 'hello_movieengine_heading_header_bg', array(
		...
		$wp_customize->add_control( new Hello_Cine Movie Engine_Customize_Alpha_Color_Control( $wp_customize, 'hello_movieengine_header_bg_color', array(
